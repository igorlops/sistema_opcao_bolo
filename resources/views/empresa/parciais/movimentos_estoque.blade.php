                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ data_iso_para_br($movimentoEstoque->create_at) }}</td>
                                <td><span class="badge badge-{{$movimentoEstoque->tipo === 'saida' ? 'danger' : 'entrada'}}">{{ ucfirst($movimentoEstoque->tipo) }}</span></td>
