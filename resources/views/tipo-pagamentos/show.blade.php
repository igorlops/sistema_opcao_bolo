            ...
            <div class="col-md-12">
                <div class="card bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/tipo-pagamentos/' . $tipopagamento->id . '/edit') }}" title="Editar Tipo de Pagamento"><button class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i> Atualizar</button></a>

                        <form method="POST" action="{{ url('tipopagamentos' . '/' . $tipopagamento->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                            <button type="submit" class="btn btn-danger btn-sm" title="Deletar Tipo de Pagamento" onclick="return confirm(&quot;Tem certeza?&quot;)"><i class="bi bi-trash"></i> Apagar</button>
                        </form>
                        <br/>
                        <br/>
