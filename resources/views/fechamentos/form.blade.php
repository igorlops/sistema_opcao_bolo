<div class="form-group row {{ $errors->has('total_vendas') ? 'has-error' : ''}}">
    ...
    <label for="saldo_ini" class="col-form-label col-sm-2 required">{{ 'Saldo Ini' }}</label>
    <div class="col-sm-10">
    ...
    <label for="saldo_fin" class="col-form-label col-sm-2 required">{{ 'Saldo Fin' }}</label>
    <div class="col-sm-10">
    ...
    <label for="diferenca_caixa" class="col-form-label col-sm-2 required">{{ 'Diferenca Caixa' }}</label>
    <div class="col-sm-10">
    ...
    <label for="id_imagem" class="col-form-label col-sm-2 required">{{ 'Id Imagem' }}</label>
    <div class="col-sm-10">
    ...
    <div class="col-sm-10">
        <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($fechamento->user_id) ? $fechamento->user_id : ''}}" required>
